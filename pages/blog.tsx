...
const howToSteps = [
  { name: 'Open HomePrep AI', text: 'Go to the workspace and enter the inputs HomePrep AI asks for.' },
  { name: 'Generate the draft', text: 'Run HomePrep AI to get a structured plain-English result.' },
...
export default function Page() {
  ...
  const SHORT = "HomePrep AI turns your home type and timeline into a prioritized prep checklist."
  return (
    <>
      <Head>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-lg font-semibold text-slate-900" data-geo-short-lead="1">HomePrep AI turns your home type and timeline into a prioritized prep checklist.</p>
