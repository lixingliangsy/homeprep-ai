  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://homeprep-ai.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is HomePrep AI?", "acceptedAnswer": {"@type": "Answer", "text": "HomePrep AI is a tool that turns your home type and timeline into a prioritized prep checklist for photos and showings."}}, {"@type": "Question", "name": "What does the checklist cover?", "acceptedAnswer": {"@type": "Answer", "text": "What to fix, declutter, and stage, prioritized by impact on presentation."}}, {"@type": "Question", "name": "Is it expensive to follow?", "acceptedAnswer": {"@type": "Answer", "text": "The tips are budget-friendly, favoring low-cost prep over renovations."}}, {"@type": "Question", "name": "Does it fit my schedule?", "acceptedAnswer": {"@type": "Answer", "text": "It is timeline-based so the plan matches the days you have before photos."}}, {"@type": "Question", "name": "Who should use it?", "acceptedAnswer": {"@type": "Answer", "text": "Homeowners and agents who want a photo-ready prep plan without a full stager."}}, {"@type": "Question", "name": "Does it help with before-photos?", "acceptedAnswer": {"@type": "Answer", "text": "It includes before-photos tips so you capture the home at its best."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">HomePrep AI - definition</h2>
...
<section id="features" className="py-20">
        ...
        <section id="studio" className="py-20">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-extrabold text-center mb-4">Trusted by engineering teams</h2>
            <p className="text-center text-slate-600 mb-12 max-w-2xl mx-auto">
              Social proof uses templates until real, consented testimonials exist. Trusted by <strong>[X]+</strong> developers and AppSec.
            </p>
