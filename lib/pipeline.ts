...
export const PIPELINE_ID = 'homeprep-ai-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Home type & timeline",
  process: "Step 2/3 · Prioritize fix / declutter / stage",
  output: "Step 3/3 · Photo-ready prep checklist",
}
