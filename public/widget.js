 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="homeprep-ai" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "homeprep-ai";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "homeprep-ai") + "_chat_session";
